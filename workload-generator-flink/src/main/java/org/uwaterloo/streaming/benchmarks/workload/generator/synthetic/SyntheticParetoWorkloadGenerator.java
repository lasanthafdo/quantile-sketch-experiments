package org.uwaterloo.streaming.benchmarks.workload.generator.synthetic;

import org.uwaterloo.streaming.benchmarks.workload.generator.timestamp.EventTimeGenerator;
import org.uwaterloo.streaming.benchmarks.workload.generator.timestamp.ExponentialOffsetEventTimeGenerator;
import org.uwaterloo.streaming.benchmarks.workload.generator.timestamp.NoOffsetEventTimeGenerator;
...
public class SyntheticParetoWorkloadGenerator implements Runnable {
    ...
    boolean emitThroughput(Random random, long currTimeInMsec, double numOfEventsPerMS) {
        ...
        for (int i = 0; i < numOfEventsPerMsInt; i++) {
            ...
            eventMap.put(SyntheticConstants.HEADER_PARETO, String.valueOf(round(ptoD.sample(), 4)));
