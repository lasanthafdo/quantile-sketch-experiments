...
public class SyntheticUniformQueryUDDSketch implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticUniformQueryUDDSketch.class);


    public SyntheticUniformQueryUDDSketch(
    ...
    private void addQuery(StreamExecutionEnvironment env) {
        ...
        messageStream
            ...
            .name("DeserializeInput ")
            .name("Window")
            .writeAsText("results-synu-udds.txt", FileSystem.WriteMode.OVERWRITE);
    }
