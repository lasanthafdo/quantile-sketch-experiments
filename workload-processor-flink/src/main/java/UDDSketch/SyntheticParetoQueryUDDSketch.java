...
public class SyntheticParetoQueryUDDSketch implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticParetoQueryUDDSketch.class);


    public SyntheticParetoQueryUDDSketch(
    ...
    private void addQuery(StreamExecutionEnvironment env) {
        ...
        messageStream
            ...
            .name("DeserializeInput ")
            .name("Window")
            .writeAsText("results-synp-udds.txt", FileSystem.WriteMode.OVERWRITE);
    }
