package org.uwaterloo.streaming.benchmarks.workload.processor.ddsketch;
...
public class TaxiQueryDDSketch implements Runnable {
...
//    private final StreamTaskSchedulerPolicy schedulerPolicy;
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(TaxiQueryDDSketch.class);


    public TaxiQueryDDSketch(ParameterTool setupParams, int numQueries, int windowSize) {
