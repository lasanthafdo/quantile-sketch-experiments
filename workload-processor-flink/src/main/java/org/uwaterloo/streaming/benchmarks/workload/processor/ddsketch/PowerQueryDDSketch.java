...
public class PowerQueryDDSketch implements Runnable {
...
//    private final StreamTaskSchedulerPolicy schedulerPolicy;
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(PowerQueryDDSketch.class);


    public PowerQueryDDSketch(
