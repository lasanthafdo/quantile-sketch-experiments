...
public class PowerQueryDDSketchCollapsing implements Runnable {
...
//    private final StreamTaskSchedulerPolicy schedulerPolicy;
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(PowerQueryDDSketchCollapsing.class);
