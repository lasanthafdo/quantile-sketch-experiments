...
public class SyntheticParetoQueryDDSketchCollapsing implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticParetoQueryDDSketchCollapsing.class);


    public SyntheticParetoQueryDDSketchCollapsing(
