...
public class SyntheticUniformQueryDDSketchCollapsing implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticUniformQueryDDSketchCollapsing.class);


    public SyntheticUniformQueryDDSketchCollapsing(
    ...
    private static class WindowAdsAggregatorMSketch implements AggregateFunction<
        ...
        public Tuple2<Long, DDSketch> add(Tuple3<String, String, String> value,
            ...
            accumulator.f1.accept(parseDouble(value.f0)); // f0 is uniform
