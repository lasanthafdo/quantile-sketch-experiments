package org.uwaterloo.streaming.benchmarks.workload.processor.ddsketch.collapsing;
...
public class TaxiQueryDDSketchCollapsing implements Runnable {
...
//    private final StreamTaskSchedulerPolicy schedulerPolicy;
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(TaxiQueryDDSketchCollapsing.class);


    public TaxiQueryDDSketchCollapsing(ParameterTool setupParams, int numQueries, int windowSize) {
    ...
    private void addQuery(StreamExecutionEnvironment env) {
        ...
        messageStream
            ...
            .aggregate(new WindowAdsAggregatorMSketch(windowSize)).name("DeserializeInput ").name("Window")
    ...
    private static class WindowAdsAggregatorMSketch implements
        AggregateFunction<Tuple7<String, String, String, String, String, String, Boolean>, Tuple2<Long, DDSketch>, Tuple2<Long, ArrayList<Double>>> {
        ...
        public Tuple2<Long, DDSketch> createAccumulator() {
            ...
            DDSketch sketch =
                new DDSketch(new LogarithmicMapping(relativeAccuracy), () -> new CollapsingLowestDenseStore(1024));
        ...
        @Override
        public Tuple2<Long, DDSketch> merge(Tuple2<Long, DDSketch> acc0, Tuple2<Long, DDSketch> acc1) {
