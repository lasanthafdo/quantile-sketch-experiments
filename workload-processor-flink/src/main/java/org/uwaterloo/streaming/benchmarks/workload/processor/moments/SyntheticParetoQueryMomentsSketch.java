package org.uwaterloo.streaming.benchmarks.workload.processor.moments;
...
public class SyntheticParetoQueryMomentsSketch implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Running Synthetic Pareto Moments Query");
        LOG.info("Running Synthetic Pareto Moments Query");
