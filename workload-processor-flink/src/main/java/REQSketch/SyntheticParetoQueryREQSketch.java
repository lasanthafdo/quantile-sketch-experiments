...
public class SyntheticParetoQueryREQSketch implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticParetoQueryREQSketch.class);

    public SyntheticParetoQueryREQSketch(ParameterTool setupParams, int numQueries, int windowSize) {
