...
public class SyntheticQueryREQSketch implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticQueryREQSketch.class);

    public SyntheticQueryREQSketch(ParameterTool setupParams, int numQueries, int windowSize) {
    ...
    private void addQuery(StreamExecutionEnvironment env) {
        ...
        messageStream
            ...
            .writeAsText("results-syn-req.txt", FileSystem.WriteMode.OVERWRITE);
    }
