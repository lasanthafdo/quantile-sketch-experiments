...
public class SyntheticUniformQueryREQSketch implements Runnable {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(SyntheticUniformQueryREQSketch.class);

    public SyntheticUniformQueryREQSketch(ParameterTool setupParams, int numQueries, int windowSize) {
